<h1 align="center">Lizz compatible Vinted Notifier application</h1>

Lizz compatible application to add the [Vinted Notifier](https://gitlab.com/airKlizz/vinted-notifier) application to a lizz managed Kubernetes cluster.
...
lizz add github \
    --owner=$GITHUB_USER  \
    --fleet=fleet \
    --origin-url=https://github.com/openlizz/application-vinted-notifier \
    --path=./ \
    --destination=vinted-notifier \
    --set-value token=$SLACK_BOT_TOKEN \
    --personal
```
